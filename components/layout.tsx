        ...
        >
          ...
          <HStack>
            ...
            <FormControl display="flex" width="fit-content" alignItems="center">
              <FormLabel color="teal" htmlFor="isInvalid" mb="0">
                Network
              </FormLabel>
              <Switch onChange={onChange} colorScheme="teal" id="isInvalid" />
            </FormControl>
            {isChecked ? (
              <WalletMultiButton className={styles.walletAdapterButton} />
            ) : (
              <ConnectButton />
            )}
          </HStack>
